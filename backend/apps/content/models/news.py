...
class News(models.Model):
    ...
    is_published_landing = models.BooleanField(
        verbose_name=_("Является опубликованым на главной странице"),
        default=False,
    )
    ...
    date = models.DateTimeField(
        verbose_name=_("Дата новости"), blank=True, null=True
    )
    date_created = models.DateTimeField(
        verbose_name=_("Дата создания"), auto_now_add=True
    )
    date_updated = models.DateTimeField(
        verbose_name=_("Дата последнего обновления"), auto_now=True
    )
